...
export default function HomophoneGroupsScreen({ navigation }) {
  ...
  // ── FALLBACK (Debug) ────────────────────────
  console.log("[HomophoneGroupsScreen] Unhandled state:", state);
  return (
    <View style={styles.center}>
      <Text style={styles.errorText}>Unhandled state: {state}</Text>
      <Text style={styles.errorText}>Debug: userId={userId}</Text>
      <TouchableOpacity style={styles.retryBtn} onPress={() => setState(STATES.SETUP)}>
        <Text style={styles.retryBtnText}>Back to Setup</Text>
      </TouchableOpacity>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  scoreLabel: { fontSize: 12, color: COLORS.textMuted, fontWeight: "600", textTransform: "uppercase" },
  scoreValue: { fontSize: 18, fontWeight: "700", color: COLORS.primary, marginTop: 4 },
  scoreDivider: { width: 1, height: 24, backgroundColor: COLORS.border, marginHorizontal: 8 },

  // Listen Card
  listenCard: { backgroundColor: COLORS.card, borderRadius: 20, padding: 20, marginBottom: 20, ...SHADOWS.medium, alignItems: "center" },
  speakBtn: {
  ...
  sentenceLabel: { fontSize: 12, color: COLORS.textMuted, marginBottom: 4, fontWeight: "600", textTransform: "uppercase" },
  sentenceText: { fontSize: 16, color: COLORS.text, textAlign: "center", fontStyle: "italic", lineHeight: 24 },

  // Choices
  choicesSection: { marginBottom: 20 },
  choicesLabel: { fontSize: 15, fontWeight: "600", color: COLORS.textSecondary, marginBottom: 14, textAlign: "center" },
  choicesGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12, justifyContent: "center" },
  choiceButton: {
    width: "46%", backgroundColor: COLORS.card, borderRadius: 16,
    paddingVertical: 18, paddingHorizontal: 12, alignItems: "center",
    borderWidth: 2, borderColor: COLORS.border, ...SHADOWS.small, position: "relative"
  },
  choiceCorrect: { backgroundColor: "rgba(0, 184, 148, 0.1)", borderColor: "#00B894" },
  choiceWrong: { backgroundColor: "rgba(255, 107, 107, 0.1)", borderColor: COLORS.error },
  choiceDim: { opacity: 0.45 },
  choiceText: { fontSize: 20, fontWeight: "700", color: COLORS.text },
  choiceTextCorrect: { color: "#00B894" },
  choiceTextWrong: { color: COLORS.error },
  choiceTextDim: { color: COLORS.textMuted },
  phoneticText: { fontSize: 12, color: COLORS.textMuted, marginTop: 4 },
  ...
  resultCorrect: { backgroundColor: "rgba(0, 184, 148, 0.12)" },
  resultWrong: { backgroundColor: "rgba(255, 107, 107, 0.10)" },
  resultEmoji: { fontSize: 32 },
  resultTextContainer: { flex: 1 },
  resultTitle: { fontSize: 18, fontWeight: "700", color: COLORS.text },
  resultSub: { fontSize: 14, color: COLORS.textSecondary, marginTop: 2 },
  resultWord: { fontWeight: "700", color: COLORS.text },
  ...
  errorText: { fontSize: 15, color: COLORS.textSecondary, textAlign: "center", marginVertical: 16 },
  ...
  setupTitle: { fontSize: 28, fontWeight: "700", color: COLORS.text, marginBottom: 8, textAlign: "center" },
  setupSubtitle: { fontSize: 16, color: COLORS.textSecondary, textAlign: "center" },

  setupCard: { backgroundColor: COLORS.card, borderRadius: 20, padding: 24, marginBottom: 20, ...SHADOWS.medium },
  setupLabel: { fontSize: 16, fontWeight: "700", color: COLORS.text, marginBottom: 20, textAlign: "center" },
  ...
  resultsTitle: { fontSize: 32, fontWeight: "700", color: COLORS.text, marginBottom: 4, textAlign: "center" },
  resultsSubtitle: { fontSize: 18, color: COLORS.textSecondary, marginBottom: 28, textAlign: "center" },

  resultsCard: { width: "100%", backgroundColor: COLORS.card, borderRadius: 16, padding: 20, marginBottom: 24, ...SHADOWS.small },
  resultsRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-around" },
  resultsItem: { alignItems: "center", flex: 1 },
  resultsItemLabel: { fontSize: 12, color: COLORS.textMuted, fontWeight: "600", textTransform: "uppercase", marginBottom: 8 },
  resultsItemValue: { fontSize: 28, fontWeight: "700", color: COLORS.primary },
  resultsDivider: { width: 1, height: 40, backgroundColor: COLORS.border, marginHorizontal: 12 },

  feedbackCard: { width: "100%", backgroundColor: `${COLORS.primary}12`, borderRadius: 16, padding: 20, marginBottom: 28, borderLeftWidth: 4, borderLeftColor: COLORS.primary },
  feedbackTitle: { fontSize: 18, fontWeight: "700", color: COLORS.text, marginBottom: 8 },
  feedbackText: { fontSize: 15, color: COLORS.textSecondary, lineHeight: 22 },
  ...
  exitButtonAlt: {
    ...
    backgroundColor: COLORS.card, borderRadius: 16, paddingVertical: 16, borderWidth: 2, borderColor: COLORS.border
  },
  exitButtonAltText: { fontSize: 17, fontWeight: "700", color: COLORS.text },
});
